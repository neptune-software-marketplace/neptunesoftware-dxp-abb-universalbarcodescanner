Implementation Guide for the Barcode Scanning Building Block using ZXing:
...
3. Camera Selection: The app detects available cameras automatically, using the first camera in the list by default.

4. Start Capturing: Click the Start button, then grant the app permission to access your camera.

5. Scan Barcode: Position the barcode in front of the camera. The app will automatically capture the barcode and display the result in the designated field.
